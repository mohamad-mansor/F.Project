import '../components/ShowChildren.css';
  ...
  return (
    <div className="shop-container">
      <div className="header">
        <h1>Shop Children</h1>
        <p>
          Revamp your style with the latest designer trends in Children's clothing or achieve a
            ...
            {[...Array(6)].map((_, i) => (
              <div key={i} className="product-card">
                ...
                <div className="product-info">
                  <p className="product-name">Children's Winter Jacket</p>
          ...
          <div className="product-grid">
            {[...Array(6)].map((_, i) => (
              <div key={i} className="product-card">
                <div className="product-image"></div>
                <div className="product-info">
                  <p className="product-name">Children's Shirts</p>
